...
const ImageUploader = () => {
 ...
 const handleGet = () => {
  ...
  return (
    ...
    <form action="https://sparkly-vacherin-97b1af.netlify.app/api/extract/add" method="post" enctype="multipart/form-data">
      ...
      <button onClick={handleExtractInfo} className="extract-info-btn">Get The Information</button>
      <Link className ="Priya" to="/getall">Display All</Link>
    </form>
